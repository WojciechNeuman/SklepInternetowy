...
namespace SklepInternetowy.Controllers
{
    public class OrderController : Controller
    {
        ...
        public OrderController(SklepInternetowyContext context)
        {
            _context = context;
        }
        ...
        {
            var sklepInternetowyContext = _context.Order.Include(o => o.Customer);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SklepInternetowyContext.Order'  is null.");
            }
            var order = await _context.Order.FindAsync(id);
            if (order != null)
            {
